...
The chatbot application remains a separate repository. This checkout currently
requires the missing authorized M-Mesob source PDF before a production build can pass.
...
- **Current structured content:** 36 published digital-system records, 45 active KPI definitions, nine legacy draft observations plus nine published successor observations, 33 published ETEX 2025 observations and one conflicting ETEX 2025 draft observation, 11 active portfolio-dashboard configurations, seven published ETEX 2025 transformation stories plus one draft legacy story, and seven published ETEX 2025 FAQs. Each published system has approved Afaan Oromo and Amharic translations.
