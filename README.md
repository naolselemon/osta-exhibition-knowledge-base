...
exception allows the organization-approved M-MESOB records to build without
creating substitute evidence.
...
> [!IMPORTANT]
> Repository presence is not publication approval. The six existing systems retain recorded organizational-leadership and language-review authorization. The 30 ETEX 2025 systems, their 33 non-conflicting successor KPI observations, seven transformation stories, and seven FAQs are published per the explicit publication request recorded in this PR; the conflicting E-Land services observation remains draft. Only validated, reviewed, verified, public-classified, non-personal, explicitly display-approved content can enter the public build.

<a id="repository-status"></a>
## Repository Status

- **Model version:** `1.0.0`, declared in [`pyproject.toml`](pyproject.toml).
- **Current structured content:** 37 published digital-system records, 45 active KPI definitions, nine legacy draft observations plus nine published successor observations, three published M-MESOB successor observations, 33 published ETEX 2025 observations and one conflicting ETEX 2025 draft observation, 11 active portfolio-dashboard configurations, seven published ETEX 2025 transformation stories plus one draft legacy story, seven approved published ETEX 2025 FAQs, and 102 generated published FAQ records with native-speaker-approved Afaan Oromo and Amharic translations.
